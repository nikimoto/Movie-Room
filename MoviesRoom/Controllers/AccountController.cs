...
using MoviesRoom.ViewModels.Account;
...
namespace MoviesRoom.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ExternalLoginCallback(string loginProvider, string returnUrl)
        {
            ...
            else
            {
                ...
                return View("ExternalLoginConfirmation",
                    ...
                    {
                        UserName = id.Name,
                        Email = id.Claims.FirstOrDefault(cl => cl.Type == ClaimTypes.Email).Value,
                        FirstName = id.Claims.FirstOrDefault(cl => cl.Type == ClaimTypes.GivenName).Value,
                        LastName = id.Claims.FirstOrDefault(cl => cl.Type == ClaimTypes.Surname).Value,
                    });
            }
        }
        ...
        private Task<IdentityResult> AddUserToRole(string id, string roleId)
        {
            return this.IdentityManager.Roles.AddUserToRoleAsync(id, roleId);
        }
